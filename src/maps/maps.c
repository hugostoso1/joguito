...
void map0_setup(Game *g)
{
    ...
    g->maps[0].enemies[rand()%4].has_key = 1;
...
void map1_setup(Game *g)
{
    ...
    for (int i = 0; i < g->maps[1].num_enemies; i++)
    {
        ...
        g->maps[1].enemies[i].enemyBullet.speed = 2;
...
void map4_setup(Game *g){
    ...
    g->maps[4].barriers[0] = (Rectangle) {g->screenWidth * 0.13, g->screenHeight/2 - 10, g->screenWidth/6, 20};
    g->maps[4].barriers[1] = (Rectangle) {g->screenWidth * 0.41, g->screenHeight/2 - 10, g->screenWidth/6, 20};
    g->maps[4].barriers[2] = (Rectangle) {g->screenWidth * 0.69, g->screenHeight/2 - 10, g->screenWidth/6, 20};
...
void map6_setup(Game *g){
    ...
    g->maps[6].door = (Rectangle) {g->screenWidth - (50 + SCREEN_BORDER), g->screenHeight - 6, 50, SCREEN_BORDER};
    ...
    for(int i=0; i< g->maps[6].num_enemies; i++){
        g->maps[6].enemies[i].pos = (Rectangle) { 0.4*g->screenWidth, 0.15*g->screenHeight, STD_SIZE_X, STD_SIZE_Y};
    ...
    g->maps[6].enemies[rand()%4].has_key = 1;
...
void resetMap(Game *g){
    switch(g->curr_map){
        ...
        case 5:
            g->hero.pos = (Rectangle) {STD_SIZE_X + 5, g->screenHeight/2 - STD_SIZE_Y/2, STD_SIZE_X, STD_SIZE_Y};
            map5_setup(g);
            break;

        case 6:
            g->hero.pos = (Rectangle) {STD_SIZE_X, g->screenHeight/2, STD_SIZE_X, STD_SIZE_Y};
            map6_setup(g);
            break;

        case 7:
            g->hero.pos = (Rectangle) {g->screenWidth - (SCREEN_BORDER + STD_SIZE_X), STD_SIZE_Y, STD_SIZE_X, STD_SIZE_Y};
            map7_setup(g);
            break;
